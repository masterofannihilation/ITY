...
\author{Boris Hatala \\ \href{mailto:xhatal02@vutbr.cz}{xhatal02@vutbr.cz}}
\date{}
\maketitle
...
Čím více \texttt{druhů}, \textit{řezů}, {\tiny velikostí}, {\color{green}barev} písma a~\textsc{\color{blue}jiných efektů} \underline{použijeme}, {\color{red} tím profesionálněji} bude {\fontfamily{pzc}\selectfont{dokument}} 
vypadat.
...
V~{\LaTeX}u ji sázíme raději \verb|\emph{text}| než \verb|\textit{text}.|
